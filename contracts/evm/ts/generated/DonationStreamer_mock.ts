...
export type DonationStreamerMock = {
  ...
  streamCount?: () => bigint
  streams?: (arg0: bigint) => { donor: `0x${string}`; pool: `0x${string}`; coins: readonly `0x${string}`[]; amounts_per_period: readonly bigint[]; period_length: bigint; next_ts: bigint; amounts_remaining: readonly bigint[]; periods_remaining: bigint }
  streamsDue?: () => readonly bigint[]
